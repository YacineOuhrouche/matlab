...
params.Rs        = 0.03;        % Stator resistance 
params.Ld        = 0.0006;      % d-axis inductance 
params.Lq        = 0.0007;      % q-axis inductance 
params.lambda_m  = 0.015;       % Permanent magnet flux linkage 
params.p         = 4;           % Number of pole pairs
params.J         = 0.02;        % Rotor inertia 
params.B         = 0.001;       % Viscous friction coefficient
params.Vdc       = 300;         % DC-link voltage 
